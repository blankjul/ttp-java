...
public class TTPCrossover extends AbstractCrossover<Pair<IVariable,IVariable>>{
	...
	@Override
	protected List<Pair<IVariable,IVariable>> crossover_(Pair<IVariable,IVariable> a, Pair<IVariable,IVariable> b) {
		List<IVariable> offTours = cTour.crossover(a.first, b.first);
		List<IVariable> offPlans = cPackingPlan.crossover(a.second, b.second);
