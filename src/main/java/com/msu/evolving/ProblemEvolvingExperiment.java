 ...
 *
 */
public class ProblemEvolvingExperiment extends AExperiment  {

	
	final public static String PROBLEM = "com.msu.evolving.measures.OptimalTourHypervolume";
	
	final public static int NUM_OF_CITIES = 50;
	...
	protected void setAlgorithms(List<IAlgorithm> algorithms) {
		...
		builder.setFactory(new FactoryThiefVariableFactory(NUM_OF_CITIES));
	...
	public static void main(String[] args) {
		...
		AExperiment experiment = new ProblemEvolvingExperiment();
