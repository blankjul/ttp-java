...
public class OrderedCrossoverTest extends Operator{
	...
	public void testCrossover() {
		...
		Tour result = new OrderedCrossover().crossover(t1, t2, Pair.create(2,6));
		assertEquals(Tour.createFromString("[0,6,2,3,4,5,1,9,8,7]"), result);
		
		Tour result2 = new OrderedCrossover().crossover(t1, t2, Pair.create(1,6));
	...
	public void testNoExceptionInRepition() {
		...
		for (int i = 0; i < 50; i++) {
			new OrderedCrossover().crossover(thief, rand, t1,t2);
		}
	}
